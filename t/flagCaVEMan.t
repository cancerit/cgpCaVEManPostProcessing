...
const my $test_germ_indel_bed => $test_data_path.'germline_indel.bed';
const my $test_snp_bed => $test_data_path.'';
const my $test_simple_repeat_bed => $test_data_path.'simple_repeats.bed';
const my $test_centro_repeat_bed => $test_data_path.'centromeric_repeats.bed';
